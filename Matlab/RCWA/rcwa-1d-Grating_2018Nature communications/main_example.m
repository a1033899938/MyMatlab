...
% lambda=808.65/1000; % wavelength (um)
lambda=794.5/1000; % wavelength (um)
% lambda=700/1000; % wavelength (um)
...
%%%% crossbar
% theta0=0; % incident angle [degree]
% polarization=2; % 0-conical diffraction, 1-TM polarization, 2-TE polarization
% faktorization=1; % 1-correct factorization
% 
...
resolution_z=200; % z resolution of figure
slice=2; % 1-yes, 2-no, slice only for grating region 2, E field=E/377
slice_position=0.1; % times region 2 thickness
slice2=2; % 1-yes, 2-no, only for grating region 2, E field=E/377
slice2_position=0.1; % times region 2 thickness
...
planar_field_component=2;
conical_field_component=5; %1-H_x, 2-H_y, 3-H_z, 4-E_x, 5-E_y, 6-E_z
...
switch grating
    ...
    case 10 % arbitrary grating from file
        ...
        input_grating_file='structure_GMR_test_sample.m';
end
...
switch measurement
    ...
    case 1
        ...
        step=2; % step=2 
    case 2 %
        minimum_wavelength=.78; %um
        maximum_wavelength=.80; %um
        step=(maximum_wavelength-minimum_wavelength)/100;   
    case 3 % 
        minimum_thickness=0.9; %um
        maximum_thickness=0.91; %um
        step=0.005;
    case 4
        minimum_index=1; 
        maximum_index=3; 
